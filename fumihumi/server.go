...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2018-06-02/fumihumi/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2018-06-02/fumihumi/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2018-06-02/fumihumi/db"
	"github.com/VG-Tech-Dojo/vg-1day-2018-06-02/fumihumi/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	api.GET("/rooms/:id/messages", mctr.All)
	api.GET("/rooms/:id/messages/:id", mctr.GetByID)
	api.POST("/rooms/:id/messages", mctr.Create)
	api.PUT("/rooms/:id/messages/:id", mctr.UpdateByID)
	api.DELETE("/rooms/:id/messages/:id", mctr.DeleteByID)
	// bot
